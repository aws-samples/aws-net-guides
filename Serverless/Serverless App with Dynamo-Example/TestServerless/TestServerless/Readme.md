...
WORKDIR /src
COPY ["TestServerless.csproj", "TestServerless/"]
RUN dotnet restore "TestServerless/TestServerless.csproj"

WORKDIR "/src/TestServerless"
COPY . .
RUN dotnet build "TestServerless.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "TestServerless.csproj" \
