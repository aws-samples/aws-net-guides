...
{
    /// <summary>
    /// Class to manage the AWS Settings for the application.
    /// Combination of App Settings, and values retrueved rom Parameter Store.
    /// Parameter Store values are set via the CDK Teamplate that is run in 
    /// the account as part of the setup.
    /// </summary>
